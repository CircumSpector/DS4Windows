...
public class ProfilesAutoMapper : Profile
{
    public ProfilesAutoMapper()
    {
        ...
        #region Left Stick
            ...
            .ForPath(dest => dest.LeftStick.FlickRealWorldCalibration, cfg => cfg.MapFrom(src => src.LSOutputSettings.OutputSettings.FlickSettings.RealWorldCalibration))
        ...
        #region Right Stick
            ...
            .ForPath(dest => dest.RightStick.FlickRealWorldCalibration, cfg => cfg.MapFrom(src => src.RSOutputSettings.OutputSettings.FlickSettings.RealWorldCalibration))
        ...
        #region Left Stick
            ...
            .ForPath(dest => dest.LSOutputSettings.OutputSettings.FlickSettings.RealWorldCalibration, cfg => cfg.MapFrom(src => src.LeftStick.FlickRealWorldCalibration))
        ...
        #region Right Stick
            ...
            .ForPath(dest => dest.RSOutputSettings.OutputSettings.FlickSettings.RealWorldCalibration, cfg => cfg.MapFrom(src => src.RightStick.FlickRealWorldCalibration))
