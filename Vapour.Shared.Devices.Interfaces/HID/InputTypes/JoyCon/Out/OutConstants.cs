...
public static class OutConstants
{
    ...
    public const int SubCommandHeaderLength = 8;
    public const int SubCommandLength = 64;
    public const int RumbleCommandLength = 49;

    public const int SpiDataOffset = 20;
    public const byte SpiCalibrationDataLength = 9;
    public const byte SpiStickParametersDataLength = 16;

    public const byte SubCommandHeaderOffset = 2;
    public const byte SubCommandDataOffset = 11;
    public static readonly byte[] SubCommandHeader = { 0x0, 0x1, 0x40, 0x40, 0x0, 0x1, 0x40, 0x40 };
    public const byte SubCommandReportIdIndex = 0;
    public const byte SubCommandCountIndex = 1;
    public const byte SubCommandReportId = 0x01;
    public const byte SubCommandTypeIndex = 10;
