...
{
    private readonly List<IDeviceInfo> _deviceInfos;
    ...
    public IDeviceInfo IsKnownDevice(int vid, int pid)
    {
        return _deviceInfos.SingleOrDefault(i => i.Vid == vid && i.Pid == pid);
    }

    public ICompatibleHidDevice CreateDevice(IDeviceInfo deviceInfo, IHidDevice hidDevice)
    {
