...
public class DS4OutDevice : OutDevice
{
    ...
    public override void ConvertAndSendReport(CompatibleHidDeviceInputReport state, int device = 0)
    {
        ...
        if (state.DPad == DPadDirection.NorthEast) cont.SetDPadDirection(DualShock4DPadDirection.Northeast);
        else if (state.DPad == DPadDirection.NorthWest) cont.SetDPadDirection(DualShock4DPadDirection.Northwest);
        else if (state.DPad == DPadDirection.North) cont.SetDPadDirection(DualShock4DPadDirection.North);
        else if (state.DPad == DPadDirection.West) cont.SetDPadDirection(DualShock4DPadDirection.West);
        else if (state.DPad == DPadDirection.East) cont.SetDPadDirection(DualShock4DPadDirection.East);
        else if (state.DPad == DPadDirection.SouthEast) cont.SetDPadDirection(DualShock4DPadDirection.Southeast);
        else if (state.DPad == DPadDirection.SouthWest) cont.SetDPadDirection(DualShock4DPadDirection.Southwest);
        else if (state.DPad == DPadDirection.South) cont.SetDPadDirection(DualShock4DPadDirection.South);
